...
export default function Login() {
  ...
  if (isCheckingAuth) {
    return (
      <main className="min-h-screen bg-gray-50 flex items-center justify-center p-4 w-full">
        <div className="text-gray-500 font-medium animate-pulse">Verificando acceso...</div>
      </main>
    );
  }
